...
import com.eduadministrative.quizme.databinding.LoginBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                binding.btnLog.setVisibility(View.GONE);
                binding.prgbr.setVisibility(View.VISIBLE);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                binding.prgbr.setVisibility(View.GONE);
